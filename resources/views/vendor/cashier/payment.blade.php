    ...
    <div id="app" class="h-full md:flex md:justify-center md:items-center">
        <div class="w-full max-w-lg">
            <h1 class="text-4xl font-bold text-center p-4 sm:p-6 mt-4">
                Le monant {{ $amount }} de votre paiement
            </h1>
            ...
            <div class="bg-white rounded-lg shadow-xl p-4 sm:p-6 mt-4">
                ...
                <div v-else-if="paymentIntent.status === 'processing'">
                    ...
                    <p class="mb-6">
                        Ce paiement est en cours de traitement. Rafraîchissez cette page de temps en temps pour connaître son état.
                    </p>
                </div>
                ...
                <div v-else>
                    ...
                    <div v-if="paymentIntent.status === 'requires_payment_method'" class="mb-3">
                        ...
                        <p class="mb-6">
                            Une méthode de paiement valide est nécessaire pour traiter votre paiement. Veuillez confirmer votre paiement en remplissant les détails de votre paiement ci-dessous.
                        </p>
                    ...
                    >
                        ...
                        <span v-else>
                            Confirmez votre {{ $amount }} paiement avec @{{ paymentMethodTitle }}
                        </span>
                    </button>
                </div>
