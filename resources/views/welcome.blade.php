            ...
            <section class="sticky">
                ...
                <div class="max-w-lg px-4 sm:pt-24 pt-12 sm:pb-8 mx-auto text-left md:max-w-none md:text-center">
                    <div class='text-center py-4 hidden sm:block'>
                        <button
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" fill='#00acee' width="16" height="16"
                                viewBox="0 0 24 24">
                                <path
                    ...
                    <h1
                        ...
                        <span class="inline md:block">SAAS </span>
                        <span class="relative mt-2 bg-clip-text text-[#201515] md:inline-block">APP.</span>
                    </h1>
                </div>
                ...
                <div class="max-w-lg px-4 pb-24 mx-auto text-left md:max-w-none md:text-center">
                    ...
                    @endif
                        ...
                        <button
                            class="backdrop-blur-sm transition duration-500 ease-in-out bg-[#f14545] border border-[#E2E8F0] translate-y-1 text-white hover:bg-neutral-200 text-lg font-semibold py-3 px-6 rounded-3xl inline-flex items-center">
                                    ...
                                    <div class="max-w-xl text-center lg:text-left">
                                        <div>
                                            ...
                                            <p class="max-w-xl mt-4 text-base tracking-tight text-gray-600">
                                                Utilisez ce paragraphe pour partager des informations sur votre entreprise ou vos produits. Rendez-le attrayant et intéressant, et mettez en valeur la personnalité de votre marque. Merci d’avoir visité notre site Web !
                                            </p>
                                        </div>
